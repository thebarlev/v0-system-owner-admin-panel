-- ====================================================
-- Insert Default Global Receipt Template
-- ====================================================
-- Date: January 1, 2026
-- Purpose: Insert a default receipt template available to all companies
-- ====================================================

-- Note: Run this AFTER 014-templates-table.sql
...
VALUES (
  ...
  'תבנית קבלה סטנדרטית',
  'תבנית ברירת מחדל לקבלות עם פרטי חברה, לקוח, תשלומים וחתימה',
  'receipt',
...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE '✅ Default receipt template inserted!';
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Template available to all companies as fallback';
END $$;
